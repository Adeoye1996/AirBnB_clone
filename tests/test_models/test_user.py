...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        user1 = User()
        user1.id = "123456"
        user1.created_at = user1.updated_at = dt
        user1_str = user__str__()
        self.assertIn("[User] (123456)", user1_str)
        self.assertIn("'id': '123456'", user1_str)
        self.assertIn("'created_at': " + dt_repr, user1_str)
        self.assertIn("'updated_at': " + dt_repr, user1_str)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        user1 = User(id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(user1.id, "345")
